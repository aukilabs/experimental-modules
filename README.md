...
This repository will house additional experimental modules for the Auki Network as they're developed. Each module will be independently versioned and documented.

Potential future modules may include:

- Posemesh connectivity
- Domain management
- Real-time messaging
- Spatial anchoring
